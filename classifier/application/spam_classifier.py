...
validation_data = [
    ...
    ['Здраствуйте, у меня для вас новое средство для похудения', SPAM],
    ['Добрый день! Прошу согласовать и выполнить перенос загрузок.', NOT_SPAM],
    ['Привет. Подскажи по ошибке.', NOT_SPAM],
    ['Купи вечером молоко', NOT_SPAM],
    ['Поздравляю, вы приглашены на конференцию', NOT_SPAM],
    ['Книга ждет вас в почтовом отделении', NOT_SPAM],
    ['Здраствуйте, у меня для вас отличная новость, вы выиграли 1000000 рублей', SPAM],
    ['Уважаемые сотрудники! В санаторий имеются диагностические и лечебные путевки.', NOT_SPAM],
    ['Теперь вы включены в группу "Совет - посетители" SharePoint', NOT_SPAM],
    ['Сломался телефон, ремонт всего за 500 рублей', SPAM]
]
